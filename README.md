...
- the sysmon_windows role restarts the Wazuh agent in all cases - ideally, it should call a handler to only restart the agent when the config file was changed
